...
public class GetBalance extends IntentService {
	...
	public static final String NOTIFICATION = "com.rosiewallet.GetBalance";
	public static final String ACTION_GetBalance = "com.rosiewallet.RESPONSE";
	...
	public GetBalance() {
		super("com.rosiewallet.GetBalance");
